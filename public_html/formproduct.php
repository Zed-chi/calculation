...
echo '<form class="form" method="post">';
    echo '<fieldset>';
    //echo eform('input', 'type', 'required type="text" pattern="[-а-яА-Я\w\s\.,]{1,64}"');
    echo eform('input', 'name', 'required type="text" pattern="[-а-яА-Я\w\s\.,]{1,64}"');
    echo eform('input', 'price', 'required type="text" pattern="\d{0,12},{0,1}\d{0,2}"');
    echo eform('input', 'weightpack', 'required type="text" pattern="\d{0,12},{0,1}\d{0,3}"');
    echo eform('input', 'in', 'required type="text" pattern="[-а-яА-Я\w\s\.,]{1,5}"');
